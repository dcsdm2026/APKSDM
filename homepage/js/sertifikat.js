                    ...
                    <tr class="hover:bg-slate-50 transition border-b border-slate-100">
                        ...
                        <td class="p-3 text-center">
                            <div class="flex justify-center gap-2">
                                <button onclick="sertifikatModule.editData('${d.id}')" class="text-amber-500 hover:text-amber-700 p-1 text-xs"><i class="fa-solid fa-pen-to-square"></i></button>
                                <button onclick="sertifikatModule.hapusData('${d.id}')" class="text-red-500 hover:text-red-700 p-1 text-xs"><i class="fa-solid fa-trash-can"></i></button>
                            </div>
                        </td>
                    </tr>
                `;
